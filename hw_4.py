# 1
# it = ["london", "usa", "new york","fransia", "italy", "milan", "bmw", "mers", "tesla", "honda", "toyota", "matiz", "byd", "zeekr", "lexus"]
# print(it[2:7])


# # 2
# numbers = [1, 4, 5, 47, 756, 123, 475,837,847,9847,8394,999,388,]
# numbers.reverse()
# print(numbers)
...
# 8
# songs = ["hope","lovely", "death bed", "down slovly", "bela ciao", "bones", "royalty", "midle of the night","set fire to the rain", "see you again" ]
# songs[3],songs[8]=songs[8],songs[3]
# print(songs)
...
# # 12
# it_list = list(it_company)
# index = it_list.index("Google")
# it_list[index] = "apple"
# it_company = tuple(it_list)
# print(it_company)

# # 13
# print(it_company[1:3])
